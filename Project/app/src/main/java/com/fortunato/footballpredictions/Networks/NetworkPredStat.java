...
public class NetworkPredStat implements Runnable {

    private static final String BASE_URL = "https://server1.api-football.com/";
    private String fullString;
    private List<BaseType> list = null;
    private PredictionStatisticActivity activity;
    private int requestType;

    public NetworkPredStat(String otherParms, int requestType, PredictionStatisticActivity activity) {
